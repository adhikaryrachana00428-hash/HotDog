import type { AgentContext, ArchitectureAgentOutput } from '../types.js';

export async function runArchitectureAgent(context: AgentContext): Promise<ArchitectureAgentOutput> {
